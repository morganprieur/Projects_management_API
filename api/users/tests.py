...
class ApiTests(TestCase): 
    ...
    def setUpTestData(self): 
        ...
        self.user2 = User.objects.create( 
            username='member_8888', 
            password=make_password('pass_user8888') 
        ) 
        get_user = User.objects.get( 
            username='member_9999' 
        ) 
        get_user2 = User.objects.get( 
            username='member_8888' 
        ) 
    ...
    def testContributorCreatedBySignal(self): 
        self.contrib = Contributor.objects.get(id=1) 
    ...
    def testCommentAuthorChangedBySignal(self): 
        self.assertEquals(self.user2.id, 2) 
        self.issue.author = self.user2 
        self.issue.save() 
        comment = Comment.objects.get(uuid=self.comment.uuid) 
        self.assertEquals(comment.author.id, 2) 
